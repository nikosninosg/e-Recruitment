...
experience TEXT,
job_id int(4) NOT NULL,
CONSTRAINT CON_VATH FOREIGN KEY (usr_vath) REFERENCES interview(usrname) ON DELETE CASCADE ON UPDATE CASCADE,
...
('23122345','Computer Engineering','keimeno..','Operating Systems','Windows','GUI',null)
;
...
BEGIN
 ...
 DECLARE number_of_eval int; #plithos axiologisewn
 SELECT count(*)
 INTO number_of_appl
 FROM applies
